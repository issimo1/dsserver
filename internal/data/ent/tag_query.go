...
import (
	...
	"github.com/issimo1/dsserver/internal/data/ent/tag"
)
...
func (tq *TagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tag, error) {
	...
	if query := tq.withPosts; query != nil {
		if err := tq.loadPosts(ctx, query, nodes,
			func(n *Tag) { n.Edges.Posts = []*Article{} },
			func(n *Tag, e *Article) { n.Edges.Posts = append(n.Edges.Posts, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (tq *TagQuery) loadPosts(ctx context.Context, query *ArticleQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Article)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(article.FieldID), joinT.C(tag.PostsPrimaryKey[1]))
